<div class="row">
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-body">
            	<form method="POST" action="<?php echo base_url().admin_ctrl(); ?>/add_email_template/add"  enctype="multipart/form-data">
    						...
    						<div class="col-md-12">
    							<div class="row">
    								...
    								<div class="col-sm-10 col-lg-10">
    									<input type="text" name="subject" class="form-control" placeholder="" value="" required>
    									ddssd
    								</div>
    							</div>
