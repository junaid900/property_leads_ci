                ...
                <table id="datatable-leads" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        	<?php 
        						...
        						$date1 = new DateTime($data['sold_date']);
                                $date2 = new DateTime();
        						...
        						<td>
            						<div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <?php } ?>
                                            <?php if($user_permit->view_sold == 1){ ?>
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>admin/view_lead/<?php echo $data['leads_id'].'/'.$data['parent_id'].'/sold'; ?>"><i class="fa  fa-eye mar_right"></i> View Sold</a>
                                           <?php } ?>
                                            <?php if($user_permit->edit_sold == 1){ ?>
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>admin/edit_lead/<?php echo $data['leads_id'].'/'.$data['parent_id'].'/sold'; ?>"><i class="fa  fa-pencil mar_right"></i> Edit Sold</a>
                                            <?php } ?>
                                            <?php if($user_permit->delete_sold == 1){ ?>
                                            <a class="dropdown-item" href="javascript:;"
                                       onclick="confirm_modal_action('<?php echo base_url().admin_ctrl(); ?>/manage_leads/delete/<?php echo $data['leads_id'].'/'.$param1; ?>');"><i class="fa  fa-trash-o mar_right"></i> Delete Sold</a>
                                            <?php } ?>
                                        </div>
                                    </div>
        						</td>
