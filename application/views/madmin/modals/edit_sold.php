    			...
    			<div class="card-body" style="padding-top: 0px;">
                    ...
                    <div class="row my-2">
                    	...
                    	<div class="col-md-6">
                    		...
                    		<input type="text" name="sold_amount" class="form-control" placeholder="" value="<?php echo $request->sold_amount; ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" >
                    	</div>
                    </div>
                    <div class="row">
