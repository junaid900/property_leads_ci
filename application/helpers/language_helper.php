...
if ( ! function_exists('get_phrase'))
{
    	function get_phrase($phrase = '') {
    		...
    		if ( $current_language	==	'') {
    			$current_language	=	$CI->db->get_where('system_settings' , array('type'=>'language'))->row()->description;
    		...
    		$phrase_res	=	$CI->db->get_where('language' , array('phrase' => $phrase));
    		$check_phrase ='';
    		if($phrase_res->num_rows()>0){
    		       $check_phrase  = $phrase_res->row()->phrase;
    		}
